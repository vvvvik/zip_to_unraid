#!/bin/bash
# =============================================================================
# backup_MA_tower.sh — архівування MA → Unraid Tower
# Версія: 3.6
# =============================================================================
...
YEAR="2026"
MONTH="09"
MONTH_DIR="09-Вересень"     # назва папки в exams24 (джерело)
...
SOURCE_DIR="/volume1/exams24/${YEAR}/${MONTH_DIR}"
ZIP_DIR="/volume1/exams_zip/${YEAR}/${ZIP_MONTH_DIR}"
REMOTE_MOUNT="/volume1/remotes/Leo_backups"
REMOTE_DIR="${REMOTE_MOUNT}/MA/${YEAR}/${ZIP_MONTH_DIR}"
USB_DIR="/volumeUSB1/usbshare/MA/${YEAR}/${ZIP_MONTH_DIR}"
