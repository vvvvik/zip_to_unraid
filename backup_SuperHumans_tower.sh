#!/bin/bash
# =============================================================================
# backup_SuperHumans_tower.sh — архівування SuperHumans (MA) → Unraid Tower
# Версія: 3.0
# =============================================================================
...
SOURCE_DIR="/volume1/SuperHumans/${YEAR}/${MONTH_DIR}"
ZIP_DIR="/volume1/exams_zip/SuperHumans/${YEAR}/${ZIP_MONTH_DIR}"
REMOTE_MOUNT="/volume1/remotes/Leo_backups"
REMOTE_DIR="${REMOTE_MOUNT}/MA/SuperHumans/${YEAR}/${ZIP_MONTH_DIR}"
USB_DIR="/volumeUSB1/usbshare/MA/SuperHumans/${YEAR}/${ZIP_MONTH_DIR}"
...
log "INFO" "Період   : ${YEAR}/${ZIP_MONTH_DIR}"
...
log "INFO" "========================================================"
log "INFO" "ПІДСУМОК ${CLINIC_NAME} ${YEAR}/${ZIP_MONTH_DIR}:"
